...
public final class GreetingServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.grps.HelloRequest,
      com.example.grps.HelloResponse> getGreetingMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "greeting",
      requestType = com.example.grps.HelloRequest.class,
      responseType = com.example.grps.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<com.example.grps.HelloRequest,
      com.example.grps.HelloResponse> getGreetingMethod() {
    io.grpc.MethodDescriptor<com.example.grps.HelloRequest, com.example.grps.HelloResponse> getGreetingMethod;
      ...
      synchronized (GreetingServiceGrpc.class) {
        if ((getGreetingMethod = GreetingServiceGrpc.getGreetingMethod) == null) {
          GreetingServiceGrpc.getGreetingMethod = getGreetingMethod =
              io.grpc.MethodDescriptor.<com.example.grps.HelloRequest, com.example.grps.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "greeting"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.lite.ProtoLiteUtils.marshaller(
                  com.example.grps.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.lite.ProtoLiteUtils.marshaller(
                  com.example.grps.HelloResponse.getDefaultInstance()))
              .build();
        }
      }
    }
  ...
  public static abstract class GreetingServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<com.example.grps.HelloRequest> greeting(
        io.grpc.stub.StreamObserver<com.example.grps.HelloResponse> responseObserver) {
