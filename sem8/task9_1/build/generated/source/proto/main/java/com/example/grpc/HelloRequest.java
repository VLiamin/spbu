...
public  final class HelloRequest extends
  ...
  public static final class Builder extends
      com.google.protobuf.GeneratedMessageLite.Builder<
        com.example.grpc.HelloRequest, Builder> implements
  ...
  protected final java.lang.Object dynamicMethod(
    ...
    switch (method) {
      case NEW_MUTABLE_INSTANCE: {
        return new com.example.grpc.HelloRequest();
      }
      case NEW_BUILDER: {
        return new Builder();
      }
      ...
      case GET_PARSER: {
        com.google.protobuf.Parser<com.example.grpc.HelloRequest> parser = PARSER;
        if (parser == null) {
          synchronized (com.example.grpc.HelloRequest.class) {
            parser = PARSER;
            if (parser == null) {
              parser =
                  new DefaultInstanceBasedParser<com.example.grpc.HelloRequest>(
                      DEFAULT_INSTANCE);
              PARSER = parser;
            }
          }
