...
public final class FirstPartTasks {
    ...
    public static List<Album> sortByAverageRating(Stream<Album> albums) {
        ...
        return albums.sorted(Comparator.comparing(album -> -album.getTracks().stream().mapToInt(Track::getRating).average()
    ...
    public static int moduloProduction(IntStream stream, int modulo) {
        ...
        return stream.reduce((number1, number2) -> number1 * number2 % modulo).orElse(0);
    }
